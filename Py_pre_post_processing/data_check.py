...
# go through all directories under D:\DeepLearning\HSVWesternDiagnosticMethods\Image1.
# For each directory, remove files whose names are not in the strip_id column of sS_labels.csv
import os
import pandas as pd

# Load allowed filenames from the CSV
csv_path = r'D:\DeepLearning\HSVW\BlotDx\Class_Label\gt\sS_labels.csv'
