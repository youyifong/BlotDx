...
parser.add_argument('--via_json_path', default="", type=str, help='e.g., Image_Annotation/CZ_dS_DET.json')
parser.add_argument('--mask_output_dir', default="", type=str, help='e.g., Mask/gt_dS_DET/')
args = parser.parse_known_args()[0]
print(args)

# via_json_path = 'Image_Annotation/CL_JHCL_sS_SEG.json'; mask_output_dir = 'Mask/gt_sS_SEG/'
# via_json_path = 'Image_Annotation/CZ_sS_SEG.json'; mask_output_dir = 'Mask/gt_sS_SEG/'
# via_json_path = 'Image_Annotation/CL_JHCL_dS_DET.json'; mask_output_dir = 'Mask/gt_dS_DET/'
# via_json_path = 'Image_Annotation/CZ_dS_DET.json'; mask_output_dir = 'Mask/gt_dS_DET/'

with open(args.via_json_path, 'r') as file:
    data = json.load(file)
...
for key, value in data['_via_img_metadata'].items():
    ...
    # Save the mask image
    mask_image.save(args.mask_output_dir+value['filename'].replace(".png","_mask.png"))
