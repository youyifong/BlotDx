...
for idx, sample in enumerate(test_ds):
    ...
    saveto = args.save_dir + '/' + os.path.basename(img_path).replace(".png", '_tv_masks.png')
    ...
    for box in result_boxes:
        ...
        if result_scores[i]>args.box_score_threshold and size>args.box_size_threshold:
    ...
    # outline = masks_to_outlines(imread(saveto))
